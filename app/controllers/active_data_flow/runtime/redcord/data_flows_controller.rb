    ...
    module Redcord
      class DataFlowsController < ActionController::Base
        ...
        def authenticate_heartbeat!
          return unless ActiveDataFlow::Runtime::Redcord.config.authentication_enabled

          token = request.headers["X-Heartbeat-Token"]
          expected = ActiveDataFlow::Runtime::Redcord.config.authentication_token
        ...
        def check_ip_whitelist!
          return unless ActiveDataFlow::Runtime::Redcord.config.ip_whitelisting_enabled

          whitelist = ActiveDataFlow::Runtime::Redcord.config.whitelisted_ips
